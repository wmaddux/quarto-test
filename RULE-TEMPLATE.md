...
| Status | Meaning |
| :--- | :--- |
| **PASS** | Healthy thresholds. |
| **WARNING** | Threshold exceeded, but operational. |
| **CRITICAL** | Risk of data loss or instability. |
| **⚠️ DATA MISSING** | Telemetry lacks required metrics. |
