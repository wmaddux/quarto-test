...
if os.path.exists(db_path):
    ...
    try:
        ...
        _raw = metadata.get('cluster_name', "Unnamed Cluster")
        cluster_display = "Unnamed Cluster" if (
            _raw is None or (isinstance(_raw, float) and pd.isna(_raw)) or
            not str(_raw).strip() or str(_raw).strip().lower() == "null"
        ) else _raw
